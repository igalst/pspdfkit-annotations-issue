...
type ISignatureSaveMode =
  (typeof SignatureSaveMode)[keyof typeof SignatureSaveMode];
 ...
 */
declare function OrderedMap<K, V>(
...
declare module Record$1 {
  ...
  export interface Factory<TProps extends Object> {
    ...
    ): Record$1<TProps> & Readonly<TProps>;
    new (
      values?: Partial<TProps> | Iterable<[string, any]>,
    ): Record$1<TProps> & Readonly<TProps>;
  }
 ...
 * `new` keyword during construction.
 */
declare function Record$1<TProps extends object>(
  defaultValues: TProps,
  name?: string,
): Record$1.Factory<TProps>;
...
declare class TextMarkupAnnotation<
  T extends ITextMarkupAnnotation = ITextMarkupAnnotation,
...
declare class HighlightAnnotation<
  T extends IHighlightAnnotation = IHighlightAnnotation,
> extends TextMarkupAnnotation<T> {
  blendMode: IBlendMode;
...
declare class ImageAnnotation<
  T extends IImageAnnotation = IImageAnnotation,
> extends Annotation<T> {
...
declare class InkAnnotation<
  T extends IInkAnnotation = IInkAnnotation,
> extends Annotation<T> {
  lines: List<List<DrawingPoint>>;
  lineWidth: number;
  strokeColor: Color | null;
...
type IMeasurementPrecision =
  (typeof MeasurementPrecision)[keyof typeof MeasurementPrecision];
...
type IMeasurementScaleUnitFrom =
  (typeof MeasurementScaleUnitFrom)[keyof typeof MeasurementScaleUnitFrom];
...
type IMeasurementScaleUnitTo =
  (typeof MeasurementScaleUnitTo)[keyof typeof MeasurementScaleUnitTo];
...
declare abstract class ShapeAnnotation<
  T extends IShapeAnnotation = IShapeAnnotation,
> extends Annotation<T> {
...
declare class LineAnnotation<
  T extends ILineAnnotation = ILineAnnotation,
> extends ShapeAnnotation<T> {
  startPoint: Point;
  endPoint: Point;
  lineCaps: LineCapsType | null;
  points: List<Point> | null;
...
declare class RectangleAnnotation<
  T extends IRectangleAnnotation = IRectangleAnnotation,
> extends ShapeAnnotation<T> {
...
declare class EllipseAnnotation<
  T extends IEllipseAnnotation = IEllipseAnnotation,
> extends ShapeAnnotation<T> {
  cloudyBorderIntensity: null | number;
  cloudyBorderInset: null | Inset;
  measurementBBox: null | Rect;
...
declare class PolygonAnnotation<
  T extends IPolygonAnnotation = IPolygonAnnotation,
> extends ShapeAnnotation<T> {
  points: List<Point>;
  cloudyBorderIntensity: null | number;
  static defaultValues: IObject;
...
declare class PolylineAnnotation<
  T extends IPolyLineAnnotation = IPolyLineAnnotation,
> extends ShapeAnnotation<T> {
  points: List<Point>;
...
declare class LinkAnnotation<
  T extends ILinkAnnotation = ILinkAnnotation,
> extends Annotation<T> {
  action: Action;
...
declare class NoteAnnotation<
  T extends INoteAnnotation = INoteAnnotation,
> extends Annotation<T> {
  text: {
    format: "plain";
    value: string;
...
declare class SquiggleAnnotation<
  T extends ISquiggleAnnotation = ISquiggleAnnotation,
> extends TextMarkupAnnotation<T> {
  static className: string;
  static readableName: string;
  static defaultValues: IObject;
...
declare class StrikeOutAnnotation<
  T extends IStrikeOutAnnotation = IStrikeOutAnnotation,
> extends TextMarkupAnnotation<T> {
  static className: string;
  static readableName: string;
  static defaultValues: IObject;
...
declare class TextAnnotation<
  T extends ITextAnnotation = ITextAnnotation,
> extends Annotation<T> {
  text: {
    format: "plain" | "xhtml";
    value: string;
...
declare class UnderlineAnnotation<
  T extends IUnderlineAnnotation = IUnderlineAnnotation,
> extends TextMarkupAnnotation<T> {
  static className: string;
  static readableName: string;
  static defaultValues: IObject;
...
type WidgetActionTriggerEventType =
...
declare class WidgetAnnotation<
  T extends IWidgetAnnotation = IWidgetAnnotation,
> extends Annotation<T> {
...
declare class RedactionAnnotation<
  T extends IRedactionAnnotation = IRedactionAnnotation,
> extends TextMarkupAnnotation<T> {
  fillColor: null | Color;
  overlayText: null | string;
  repeatOverlayText: null | boolean;
...
declare class MediaAnnotation<
  T extends IMediaAnnotation = IMediaAnnotation,
> extends Annotation<T> {
  description: null | string;
  fileName: null | string;
  contentType: string | null;
...
type DocumentIntegrityStatusType =
  (typeof DocumentIntegrityStatus)[keyof typeof DocumentIntegrityStatus];
...
type CertificateChainValidationStatusType =
  (typeof CertificateChainValidationStatus)[keyof typeof CertificateChainValidationStatus];
declare const SignatureValidationStatus: {
  readonly valid: "valid";
  readonly warning: "warning";
  readonly error: "error";
};
type SignatureValidationStatusType =
...
type IComparisonOperationType =
  (typeof ComparisonOperationType)[keyof typeof ComparisonOperationType];
...
declare abstract class ShapeAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<ShapeAnnotationJSON, "id" | "group" | "permissions">,
...
type SerializedAdditionalActionsType = {
  [key in
    ...
    | FormFieldInputEventTriggerType
    | WidgetActionTriggerEventType]?: {
    type: string;
    [key: string]: unknown;
  };
};
...
type DoNotSpellCheckPropertyPair = XOR<
  Record<"doNotSpellCheck", boolean>,
  Record<"doNotSpellcheck", boolean>
>;
...
export type AnnotationJSONUnion =
  ...
  | LinkAnnotationJSON
  | InkAnnotationJSON
  | RectangleAnnotationJSON
  | PolylineAnnotationJSON
  | PolygonAnnotationJSON
  | LineAnnotationJSON
  | EllipseAnnotationJSON
  | ImageAnnotationJSON
  | UnknownAnnotationJSON
  | MediaAnnotationJSON
...
declare class InkAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<InkAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): InkAnnotation;
  _linesToJSON(): {
    points: [number, number][][];
...
declare class LineAnnotationSerializer extends ShapeAnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<LineAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): LineAnnotation;
}
...
declare class RectangleAnnotationSerializer extends ShapeAnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<RectangleAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): RectangleAnnotation;
}
...
declare class EllipseAnnotationSerializer extends ShapeAnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<EllipseAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): EllipseAnnotation;
}
...
declare class PolygonAnnotationSerializer extends ShapeAnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<PolygonAnnotationJSON, "id" | "group" | "permissions">,
    options?: IObject,
  ): PolygonAnnotation;
}
...
declare class PolylineAnnotationSerializer extends ShapeAnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<PolylineAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): PolylineAnnotation;
}
...
declare class LinkAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<LinkAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): LinkAnnotation;
}
...
declare abstract class BaseTextMarkupSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<BaseTextMarkupAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): {
    rects: List<Rect>;
    group?: string | null | undefined;
...
declare class TextMarkupAnnotationSerializer extends BaseTextMarkupSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<TextMarkupAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
...
declare class RedactionAnnotationSerializer extends BaseTextMarkupSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<RedactionAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): RedactionAnnotation;
}
...
declare class TextAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<TextAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): TextAnnotation;
  _calloutToJSON(): {
    start: [number, number];
  ...
  static _JSONToCallout(
    calloutJSON: TextAnnotationJSON["callout"],
  ): Callout | null | undefined;
}
...
declare class NoteAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<NoteAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): NoteAnnotation;
}
...
declare class ImageAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<ImageAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): ImageAnnotation;
}
...
declare class StampAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<StampAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): StampAnnotation;
}
...
declare class WidgetAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<WidgetAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): WidgetAnnotation;
}
...
declare class CommentMarkerAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: InstantID | null,
    json: Omit<CommentMarkerAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
...
declare class UnknownAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<UnknownAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): UnknownAnnotation;
}
...
declare class MediaAnnotationSerializer extends AnnotationSerializer {
  ...
  static fromJSON(
    id: ID | null,
    json: Omit<MediaAnnotationJSON, "id" | "group" | "permissions">,
    options?: ICollaboratorPermissionsOptions,
  ): MediaAnnotation;
}
...
type GetTypeFromAnnotationJSON<
  T extends {
...
type AnnotationBackendJSON<
  K extends BaseAnnotationJSON = AnnotationJSONUnion,
  R extends string = never,
> = {
  [P in keyof K]?: NonNullable<K[P]>;
} & {
  [P in Intersection<keyof K, BackendRequiredKeys | R>]-?: Exclude<
    NonNullable<K[P]>,
    undefined
  >;
};
...
type AnnotationsUnionClass = {
  [K in keyof AnnotationSerializerTypeMap]: Class<
    AnnotationSerializerTypeMap[K]["annotation"]
  >;
}[keyof AnnotationSerializerTypeMap];
type ShapeAnnotationsUnion =
  | PolylineAnnotation
  | PolygonAnnotation
  | LineAnnotation
  | RectangleAnnotation
...
type TextMarkupAnnotationsUnion =
  | HighlightAnnotation
  | UnderlineAnnotation
  | StrikeOutAnnotation
  | SquiggleAnnotation
...
type ISidebarPlacement =
  (typeof SidebarPlacement)[keyof typeof SidebarPlacement];
...
type IShowSignatureValidationStatusMode =
  (typeof ShowSignatureValidationStatusMode)[keyof typeof ShowSignatureValidationStatusMode];
...
type ISignatureAppearanceMode =
  (typeof SignatureAppearanceMode)[keyof typeof SignatureAppearanceMode];
...
interface ITextSelection$1 {
  startNestedTextBlockId: string | null;
  startTextLineId: number | null;
  startPageIndex: number | null;
  startNode: Text | null;
  startOffset: number | null;
  endNestedTextBlockId: string | null;
...
declare class PublicTextSelection extends PublicTextSelection_base {
  ...
  startNestedTextBlockId: string;
  startPageIndex: number;
  startNode: Text;
  startOffset: number;
  endTextLineId: number;
  endNestedTextBlockId: string;
  endPageIndex: number;
  endNode: Text;
  endOffset: number;
...
declare class AnnotationNote<
  T extends AnnotationNoteProps = AnnotationNoteProps,
> extends NoteAnnotation<T> {
...
type IDocumentComparisonSourceType =
  (typeof DocumentComparisonSourceType)[keyof typeof DocumentComparisonSourceType];

type DocumentComparisonSource = {
  source:
    | IDocumentComparisonSourceType
    | string
    | ArrayBuffer
...
export interface EventMap {
  ...
  "instant.connectedClients.change": (
    clients: Map<string, InstantClient>,
  ) => void;
...
declare const builtInItems: readonly [
  "highlight",
  "strikeout",
  "underline",
  "squiggle",
...
type StoredSignaturesSetter = (
  annotations: List<InkAnnotation | ImageAnnotation>,
) => List<InkAnnotation | ImageAnnotation>;
type SearchStateSetter = (currentState: SearchState) => SearchState;
type AnnotationPresetsSetter = (
  currentState: Record<string, AnnotationPreset$1>,
) => Record<string, AnnotationPreset$1>;
type StampAnnotationTemplatesSetter = (
  currentState: Array<StampAnnotation | ImageAnnotation>,
) => Array<StampAnnotation | ImageAnnotation>;
type SetDocumentEditorFooterFunction = (
  currentState: DocumentEditorFooterItem[],
) => DocumentEditorFooterItem[];
type SetDocumentEditorToolbarFunction = (
...
declare class Instance {
  ...
  setCustomUIConfiguration: (
    customUIConfigurationOrConfigurationSetter:
      | CustomUI
      | ((customUI: CustomUI | null) => CustomUI),
  ) => void;
  ...
  setToolbarItems: (
    stateOrFunction: ToolbarItemsSetter | ToolbarItem[],
  ) => void;
  setAnnotationToolbarItems: (
    annotationToolbarItemsCallback: AnnotationToolbarItemsCallback,
  ) => void;
  ...
  setAnnotationPresets: (
    stateOrFunction:
      | AnnotationPresetsSetter
      | Record<AnnotationPresetID$1, AnnotationPreset$1>,
  ) => void;
  ...
  setStampAnnotationTemplates: (
    stateOrFunction:
      | StampAnnotationTemplatesSetter
      | Array<StampAnnotation | ImageAnnotation>,
  ) => void;
  ...
  setFormFieldValues: (
    formFieldValues: Record<string, null | string | Array<string>>,
  ) => void;
  ...
  setSelectedAnnotation: (
    annotationOrAnnotationId?: (AnnotationsUnion | ID) | null,
  ) => void;
  setSelectedAnnotations: (
    annotationsOrAnnotationsId?: List<AnnotationsUnion | ID> | null,
  ) => void;
  groupAnnotations: (
    annotationsOrAnnotationsId?: List<AnnotationsUnion | ID>,
  ) => void;
  ...
  setDocumentEditorFooterItems: (
    stateOrFunction:
      | DocumentEditorFooterItem[]
      | SetDocumentEditorFooterFunction,
  ) => void;
  ...
  signDocument: (
    arg0: SignatureCreationData | null,
    arg1?: TwoStepSignatureCallback | SigningServiceData,
  ) => Promise<void>;
  applyOperations: (operations: Array<DocumentOperation>) => Promise<void>;
  exportPDFWithOperations: (
    arg0: Array<DocumentOperation>,
  ) => Promise<ArrayBuffer>;
  applyRedactions: () => Promise<void>;
  save: () => Promise<void>;
  hasUnsavedChanges: () => boolean;
  ensureChangesSaved: (
    changes: Change | Array<Change>,
  ) => Promise<Array<Change>>;
  create: (
    changes: Change | Array<Change> | List<Change>,
  ) => Promise<Array<Change>>;
  update: (
    changes: Change | Array<Change> | List<Change>,
  ) => Promise<Array<Change>>;
  delete: (
    ids:
      | InstantID
      | Change
      | Array<InstantID | Change>
      | List<InstantID | Change>,
  ) => Promise<Array<Change>>;
...
type ITextLineElementKind =
  (typeof TextLineElementKind)[keyof typeof TextLineElementKind];
...
type IToolbarPlacement =
  (typeof ToolbarPlacement)[keyof typeof ToolbarPlacement];
...
type IModificationType =
  (typeof ModificationType)[keyof typeof ModificationType];
...
declare function PSPDFKitSaveError(
  messageOrError: string | Error,
  reason: Array<SaveErrorReason>,
): Error;
declare namespace PSPDFKitSaveError {
  var prototype: any;
}

type AnnotationTooltipCallback = (
  annotation: AnnotationsUnion,
) => Array<ToolItem>;
...
declare class Font extends Font_base {
  constructor(args: { name: string; callback?: FontCallback });
}
...
type IElectronicSignatureCreationMode =
  (typeof ElectronicSignatureCreationMode)[keyof typeof ElectronicSignatureCreationMode];
...
type IUIDateTimeElement =
  (typeof UIDateTimeElement)[keyof typeof UIDateTimeElement];
...
type SharedConfiguration = {
  ...
  populateStoredSignatures?: () => Promise<
    List<InkAnnotation | ImageAnnotation>
  >;
...
declare class __dangerousImmutableRecordFactory<
...
declare class InheritableImmutableRecord<
  T extends Record<string, unknown>,
> extends InheritableImmutableRecord_base {
  constructor(values?: Partial<T> | Iterable<[string, unknown]>);
}
interface InheritableImmutableRecord<T extends Record<string, unknown>>
  extends __dangerousImmutableRecordFactory<T> {}
...
declare class Annotation<
  T extends AnnotationProperties = AnnotationProperties,
> extends InheritableImmutableRecord<T> {
  id: ID;
  name: null | string;
  subject: null | string;
...
declare class StampAnnotation<
  T extends IStampAnnotation = IStampAnnotation,
> extends Annotation<T> {
  stampType: StampKind;
  title: null | string;
...
declare function preloadWorker(
  configuration: StandaloneConfiguration,
): Promise<void>;
declare function load(configuration: Configuration): Promise<Instance>;
declare function convertToPDF(
  configuration: StandaloneConfiguration,
  conformance?: IConformance,
): Promise<ArrayBuffer>;
declare function populateDocumentTemplate(
  configuration: StandaloneConfiguration,
  templateData: TemplateDataToPopulateDocument,
): Promise<ArrayBuffer>;

declare function serializeAnnotation(
  annotation: InkAnnotation,
): AnnotationBackendJSON<InkAnnotationJSON>;
declare function serializeAnnotation(
  annotation: LineAnnotation,
): AnnotationBackendJSON<LineAnnotationJSON>;
declare function serializeAnnotation(
  annotation: RectangleAnnotation,
): AnnotationBackendJSON<RectangleAnnotationJSON>;
declare function serializeAnnotation(
  annotation: EllipseAnnotation,
): AnnotationBackendJSON<EllipseAnnotationJSON>;
declare function serializeAnnotation(
  annotation: PolygonAnnotation,
): AnnotationBackendJSON<PolygonAnnotationJSON>;
declare function serializeAnnotation(
  annotation: PolylineAnnotation,
): AnnotationBackendJSON<PolylineAnnotationJSON>;
declare function serializeAnnotation(
  annotation: TextAnnotation,
): AnnotationBackendJSON<TextAnnotationJSON>;
declare function serializeAnnotation(
  annotation: NoteAnnotation,
): AnnotationBackendJSON<NoteAnnotationJSON>;
declare function serializeAnnotation(
  annotation: StampAnnotation,
): AnnotationBackendJSON<StampAnnotationJSON, "color">;
declare function serializeAnnotation(
  annotation: ImageAnnotation,
): AnnotationBackendJSON<ImageAnnotationJSON>;
declare function serializeAnnotation(
  annotation: MediaAnnotation,
): AnnotationBackendJSON<MediaAnnotationJSON>;
declare function serializeAnnotation(
  annotation: LinkAnnotation,
): AnnotationBackendJSON<LinkAnnotationJSON>;
declare function serializeAnnotation(
  annotation: WidgetAnnotation,
): AnnotationBackendJSON<WidgetAnnotationJSON>;
declare function serializeAnnotation(
  annotation: TextMarkupAnnotation,
): AnnotationBackendJSON<TextMarkupAnnotationJSON>;
declare function serializeAnnotation(
  annotation: RedactionAnnotation,
): AnnotationBackendJSON<RedactionAnnotationJSON>;
declare function serializeAnnotation(
  annotation: CommentMarkerAnnotation,
): AnnotationBackendJSON<CommentMarkerAnnotationJSON>;
declare function serializeAnnotation(
  annotation: UnknownAnnotation,
): AnnotationBackendJSON<UnknownAnnotationJSON>;
declare function serializeAnnotation(
  annotation: AnnotationsUnion,
): AnnotationsBackendJSONUnion;
declare function serializeFormField(formField: FormField): FormFieldJSON;
declare function serializePreset(
  preset: AnnotationPreset$1,
): Record<string, any>;
declare function unserializePreset(
...
declare function viewStateFromOpenParameters(
  viewState: ViewState,
...
declare const PSPDFKit: {
  ...
  Annotations: {
    ...
    fromSerializableObject: <K extends AnnotationJSONUnion>(
      annotation: K,
    ) => AnnotationJSONToAnnotation<K>;
    rotate: (
...
export {
  ...
  TextMarkupAnnotationJSON,
  TextMarkupAnnotationsUnion,
  PublicTextSelection as TextSelection,
  ToolbarItem,
  URIAction,
  UnderlineAnnotation,
  UnknownAnnotation,
